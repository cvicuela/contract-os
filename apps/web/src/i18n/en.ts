const en = {
  ...
  login: {
    liveDemo: 'Live Demo',
    signIn: 'Sign In',
    heroTagline: 'Powered by Claude AI — the most capable AI for document analysis',
    heroTitle: 'Your contracts, finally under control',
    heroDescription: 'Upload any contract and get instant AI analysis — risk score, obligation tracking, expiry alerts, and an exact action plan to make it a perfect 10/10.',
